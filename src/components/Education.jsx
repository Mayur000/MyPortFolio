...
// Import the GraduationCap icon from lucide-react for the timeline marker
import { GraduationCap } from 'lucide-react'; 

// Main Education Component (renamed to App/Education as the single exported component)
const Education = () => {
  // Education Data
  const educationData = [
    {
      degree: "Computer Engineering (B.E.)",
      institution: "DMCE Mumbai University",
      year: "2023 - 2027 (Expected)",
      description:
        "Currently pursuing a Bachelor’s degree focusing on software development, advanced algorithms, and system design.",
    },
    {
      degree: "Higher Secondary Certificate (HSC)",
      institution: "Royal College of Science & Commerce",
      year: "2021 - 2023",
      description:
        "Completed HSC with a science stream focus.",
    },
    {
      degree: "Secondary School Certificate (SSC)",
      institution: "The SIA School",
      year: "2011 - 2021",
      description:
        "Completed SSC with distinction, establishing a strong foundation in analytical skills, logical thinking, and foundational sciences.",
    },
  ];

  return (
    // Outer container with a deep background color and smooth dark mode transition
    <div id="education" className="min-h-screen bg-gray-50 dark:bg-gray-950 py-20 font-inter transition-all duration-500">
